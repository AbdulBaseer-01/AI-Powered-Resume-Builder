export default{
    ...
    address:'X-24 xyz, xyz',
    phone:'+91-83175 39715',
    email:'abdulbaseer@gmail.com',
    themeColor:"#0a66c2",
    ...
    projects: [
        {
            ...
            description: 'A full-featured music streaming app clone with real-time database integration and user authentication',
            projectLink: 'https://github.com/yourname/spotify-clone',
        },
        {
            id: 2,
            projectName: 'E-commerce Platform',
            technologiesUsed: 'Node.js, MongoDB, Stripe API',
